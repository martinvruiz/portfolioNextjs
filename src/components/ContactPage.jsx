...
export default function ContactPage() {
  return (
    <div className="flex flex-col items-center p-4">
      <section className="flex flex-col items-center w-full max-w-xl rounded-2xl">
        ...
        <div className="flex flex-col sm:flex-row gap-6 w-full justify-center">
          <a
            ...
            className="flex items-center gap-3 bg-white rounded-2xl shadow-md px-6 py-4 text-white hover:bg-blue-800 hover:scale-105 transition-all duration-200 font-semibold text-lg justify-center"
          >
